...
function HTML() {
  ...
  const [loading,setLoading] = useState(false)
   ...
   const getData = async (page) => {
    setLoading(true)
     await axios.get(`https://api.github.com/search/repositories?q=stars:%3E1+language:HTML&desc=stargazers_count&per_page=10&page=${page}`).then((res)=>{
   ...
   return  loading? <h1>Loading...</h1> :(
     ...
     <Heading style={{color:'#aaf36a',width:'250px' , border:'1px dashed red',borderRadius:'10px', padding:'6px'}}>HTML Data</Heading>
