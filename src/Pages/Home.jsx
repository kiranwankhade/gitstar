...
function Home() {
 ...
 const [page, setPage] = useState(1);
  ...
  const getData = async (page) => {
    setLoading(true)
    await axios.get(`https://api.github.com/search/repositories?q=stars:%3E1+language:All:desc=stargazers_count&per_page=10&page=${page}`).then((res)=>{
  ...
  return  loading? <h1>Loading...</h1> :(
    ...
    <Heading style={{color:'#aaf36a',width:'200px' , border:'1px dashed red',borderRadius:'10px', padding:'6px'}}>All Data</Heading>
